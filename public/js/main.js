...
async function deleteFoodItem(){
    ...
    const foodItem = this.previousSibling.previousSibling.previousElementSibling.outerText
    console.log(this.previousSibling.previousSibling.previousElementSibling.outerText)
    this.parentNode.parentNode.removeChild(this.parentNode)
    let data = await fetch('/tracker/removeFoodItem',{
        method:'put',
        headers:{
            'Content-Type':'application/json'
        },
